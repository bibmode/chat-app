...
export default function ChannelPage() {
  ...
  return (
    <div className="lg:overflow-y-scroll lg:h-screen lg:flex">
      <Head>
      ...
      <div className="relative pt-16 lg:pt-0 pb-20 lg:pb-0 mx-auto bg-zinc-800 min-h-screen w-full lg:flex lg:flex-col ">
        {/* top bar */}
        <div className="fixed lg:sticky text-gray-50 top-0 left-0 w-full lg:w-auto bg-zinc-800 drop-shadow-lg p-4">
        ...
        <div className="lg:mb-auto lg:mt-4 px-4">
